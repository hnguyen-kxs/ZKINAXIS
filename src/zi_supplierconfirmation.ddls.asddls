...
@VDM.viewType: #BASIC
define view entity ZI_SupplierConfirmation
  as select from ekes                   as _SupplierConfirmation
    inner join   ZI_PurchasingDocItem   as _PurDocItem   on  _SupplierConfirmation.ebeln = _PurDocItem.PurchasingDocumentNumber
                                                         and _SupplierConfirmation.ebelp = _PurDocItem.ItemNumberOfPurchasingDocument
    inner join   ZI_PurchasingDocHeader as _PurDocHeader on _PurDocItem.PurchasingDocumentNumber = _PurDocHeader.PurchasingDocumentNumber
