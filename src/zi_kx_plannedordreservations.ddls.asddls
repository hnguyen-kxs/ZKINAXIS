...
define view entity ZI_KX_PlannedOrdReservations
  as select from ZI_PlannedOrder as _Order
    inner join   ZI_Allocation   as _Allocation on _Order.NumberOfReservation = _Allocation.NumberOfReservation
{
