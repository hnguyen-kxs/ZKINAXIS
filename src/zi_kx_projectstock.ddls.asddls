...
define view entity ZI_KX_ProjectStock
  as select from    ZI_ProjectStock     as _ProjectStock
    left outer join ZI_StorageLocations as _StorageLocations on  _ProjectStock.StorageLocation = _StorageLocations.StorageLocation
