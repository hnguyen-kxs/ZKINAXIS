...
@VDM.viewType: #BASIC
define view entity ZI_MatBOMLink
  as select from mast               as _MatBomLink
    inner join   ZI_TVARVC_Plant    as _TvarvcPlant    on _MatBomLink.werks = _TvarvcPlant.Low
    inner join   ZI_TVARVC_BOMUsage as _TvarvcBOMUsage on _MatBomLink.stlan = _TvarvcBOMUsage.Low
{
