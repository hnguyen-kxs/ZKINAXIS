...
define view entity ZI_KX_InfoRecords
  as select from    ZI_PurchaseInfoRecords as _PurchInfoRecords
    inner join      ZI_ProductPlant        as _ProductPlant on  _PurchInfoRecords.Plant          = _ProductPlant.Plant
                                                            and _PurchInfoRecords.MaterialNumber = _ProductPlant.MaterialNumber
    left outer join ZI_Supplier            as _Supplier     on _PurchInfoRecords.SuppliersAccountNumber = _Supplier.AccountNumberofSupplier
