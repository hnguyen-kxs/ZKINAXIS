...
define view entity ZI_KX_SchedulingAgreement
  as select from    ZI_PurchasingDocHeader as _PurchDocHeader
    inner join      ZI_PurchasingDocItem   as _PurDocItem   on _PurchDocHeader.PurchasingDocumentNumber = _PurDocItem.PurchasingDocumentNumber
    inner join      ZI_ProductPlant        as _ProductPlant on  _PurDocItem.Plant          = _ProductPlant.Plant
                                                            and _PurDocItem.MaterialNumber = _ProductPlant.MaterialNumber
    left outer join ZI_Supplier            as _Supplier     on _PurchDocHeader.SupplierAccountNumber = _Supplier.AccountNumberofSupplier
{
