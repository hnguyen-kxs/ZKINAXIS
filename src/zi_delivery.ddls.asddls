...
define view entity ZI_Delivery
  as select from    lips                   as _DeliveryItems
    ...
    inner join      ZI_TVARVC_Plant        as _TvarvcPlant    on _DeliveryItems.werks = _TvarvcPlant.Low
    inner join      ZI_TVARVC_DeliveryType as _DeliveryType   on _DeliveryHeader.lfart = _DeliveryType.Low
{
