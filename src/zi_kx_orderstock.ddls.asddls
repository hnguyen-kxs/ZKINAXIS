...
define view entity ZI_KX_OrderStock
  as select from    ZI_OrderStock       as _OrderStock
    left outer join ZI_StorageLocations as _StorageLocations on  _OrderStock.StorageLocation = _StorageLocations.StorageLocation
