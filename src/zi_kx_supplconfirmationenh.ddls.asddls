...
define view entity ZI_KX_SupplConfirmationEnh
  as select from    ZI_SupplierConfirmation as _SupplierConfirmation
    left outer join ZI_Supplier             as _Supplier on _SupplierConfirmation.SupplierAccountNumber = _Supplier.AccountNumberofSupplier
{
