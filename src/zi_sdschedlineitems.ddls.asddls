...
define view entity ZI_SDSchedLineItems
  as select from vbep                      as _SchLine
    ...
    inner join   ZI_TVARVC_Plant           as _TvarvcPlant  on _SalesIndex.werks = _TvarvcPlant.Low
    inner join   ZI_TVARVC_SalesIdx_OrdTyp as _TvarvcOrdTyp on _SalesIndex.auart = _TvarvcOrdTyp.Low
{
