...
define view entity ZI_KX_VendorStock
  as select from    ZI_VendorStock      as _VendorStock
    left outer join ZI_StorageLocations as _StorageLocations on  _VendorStock.StorageLocation = _StorageLocations.StorageLocation
