...
define view entity ZI_KX_SDItems
  as select from    ZI_SDSchedLineItems as _SchedLine
    left outer join ZI_SDLineItems      as _SDItems on  _SchedLine.SalesDocument     = _SDItems.SalesDocument
