...
define view entity ZI_KX_PurchaseDocument
  as select from ZI_SchedulingAgreementLines as _SchdLineAggr
    inner join   ZI_PurchasingDocItem        as _PurDocItem   on  _SchdLineAggr.PurchasingDocumentNumber       = _PurDocItem.PurchasingDocumentNumber
                                                              and _SchdLineAggr.ItemNumberOfPurchasingDocument = _PurDocItem.ItemNumberOfPurchasingDocument
    inner join   ZI_PurchasingDocHeader      as _PurDocHeader on _SchdLineAggr.PurchasingDocumentNumber = _PurDocHeader.PurchasingDocumentNumber
