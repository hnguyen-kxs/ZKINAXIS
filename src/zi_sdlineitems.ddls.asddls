...
define view entity ZI_SDLineItems
  as select from vbap                      as _SalesItem
    inner join   vbak                      as _SalesHeader  on _SalesItem.vbeln = _SalesHeader.vbeln
    inner join   ZI_TVARVC_Plant           as _TvarvcPlant  on _SalesItem.werks = _TvarvcPlant.Low
    inner join   ZI_TVARVC_SalesIdx_OrdTyp as _TvarvcOrdTyp on _SalesHeader.auart = _TvarvcOrdTyp.Low
{
