...

{
  ...
  key       _QuotaFileHeader.bdatu                        as QuotaArrangePeriodValidUntil,
            ...
            cast(_QuotaFileItem.ematn as abap.char(17))   as MatNoCorrespondingToMPN,
