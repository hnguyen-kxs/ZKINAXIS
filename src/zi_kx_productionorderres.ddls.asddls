...
define view entity ZI_KX_ProductionOrderRes
  as select from    ZI_KX_OrderReservation as _OrdResv
    left outer join ZI_OrderItem           as _OrdItm on _OrdResv.OrderNumber = _OrdItm.OrderNumber
{
