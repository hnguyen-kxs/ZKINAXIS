...
define view entity ZI_KX_ProdPlantValuation
  as select from    ZI_ProductPlant as _ProductPlant
    left outer join makt            as _MatDesc  on  _ProductPlant.MaterialNumber = _MatDesc.matnr
                                                 and _MatDesc.spras               = 'E'
    left outer join ZI_MRPLotSize   as _MrpLot   on _ProductPlant.LotSizingProcedure = _MrpLot.LotSize
    left outer join ZI_MRPGrp       as _MrpGrp   on  _ProductPlant.Plant    = _MrpGrp.Plant
                                                 and _ProductPlant.MRPGroup = _MrpGrp.MRPGroup
    left outer join ZI_MRPParameter as _MrpParam on _ProductPlant.Plant = _MrpParam.Plant
{
