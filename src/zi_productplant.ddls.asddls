...
define view entity ZI_ProductPlant
  as select from    nsdm_e_marc              as _MatPlant
    ...
    left outer join ZI_ProductValuation      as _ProductVal  on  _MatPlant.matnr = _ProductVal.MaterialNumber
                                                             and _MatPlant.werks = _ProductVal.ValuationArea
    left outer join ZI_SpecialProcurementKey as _SplProcKey  on  _MatPlant.sobsl = _SplProcKey.SpecialProcurementType
