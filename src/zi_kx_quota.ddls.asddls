...
define view entity ZI_KX_Quota
  as select from    ZI_Quota        as _Quota
    inner join      ZI_ProductPlant as _ProductPlant on  _Quota.Plant          = _ProductPlant.Plant
                                                     and _Quota.MaterialNumber = _ProductPlant.MaterialNumber
    left outer join ZI_Supplier     as _Supplier     on _Quota.SupplierAccountNumber = _Supplier.AccountNumberofSupplier
