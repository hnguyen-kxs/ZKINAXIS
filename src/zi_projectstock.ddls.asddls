...
@EndUserText.label: 'Inventory project stock V2'
...
@VDM.viewType: #BASIC
define view entity ZI_ProjectStock
  as select from nsdm_e_mspr     as _ProjectStock
    inner join   ZI_TVARVC_Plant as _TvarvcPlant on _ProjectStock.werks = _TvarvcPlant.Low
{
