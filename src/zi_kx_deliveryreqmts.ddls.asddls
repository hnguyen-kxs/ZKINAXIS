...
define view entity ZI_KX_DeliveryReqmts
  as select from    ZI_Delivery       as _Delivery
    inner join      ZI_SDRequirements as _Reqmts   on  _Delivery.Delivery     = _Reqmts.SalesDocument
                                                   and _Delivery.DeliveryItem = _Reqmts.SalesDocumentItem
    left outer join ZI_Customer       as _Customer on _Delivery.ShipToParty = _Customer.Customer
{
