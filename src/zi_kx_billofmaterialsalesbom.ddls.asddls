...
define view entity ZI_KX_BillOfMaterialSalesBOM
  as select from ZI_SalesBOMLink as _BOMHeader
    inner join   ZI_SalesBOMItem as _BOMItem on  _BOMHeader.BillOfMaterial = _BOMItem.BillOfMaterial
