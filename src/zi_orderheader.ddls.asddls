...
define view entity ZI_OrderHeader
  as select from afko                as _OrdHeader
    ...
    inner join   ZI_TVARVC_Plant     as _TvarvcPlant     on _OrdMaster.werks = _TvarvcPlant.Low
    inner join   ZI_TVARVC_OrderType as _TvarvcOrderType on _OrdMaster.auart = _TvarvcOrderType.Low

{
  key _OrdMaster.aufnr                            as OrderNumber,
      ...
      cast(_OrdHeader.plnbez as abap.char(40))    as AssyMaterialNumber,
      _OrdHeader.plnnr                            as KeyForTaskListGroup,
      _OrdHeader.plnty                            as TaskListType,
      _OrdHeader.rsnum                            as NumberOfReservation,
      cast(_OrdHeader.stlbez as abap.char(40))    as Material,
