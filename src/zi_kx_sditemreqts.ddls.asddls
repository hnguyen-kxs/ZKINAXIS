...
define view entity ZI_KX_SDItemReqts
  as select from    ZI_KX_SDItems     as _SDItem
    inner join      ZI_SDRequirements as _SDRequirements on  _SDItem.SalesDocument      = _SDRequirements.SalesDocument
    ...
    left outer join ZI_Customer       as _Customer       on _SDRequirements.SoldToParty = _Customer.Customer
{
