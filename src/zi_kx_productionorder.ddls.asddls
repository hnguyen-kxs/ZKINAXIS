...
define view entity ZI_KX_ProductionOrder
  as select from    ZI_OrderHeader as _Order
    left outer join ZI_OrderItem             as _OrderItem on _Order.OrderNumber = _OrderItem.OrderNumber
    left outer join ZI_ObjectStatus          as _ObjStat   on _Order.ObjectNumber = _ObjStat.ObjectNumber
{
