...
define view entity ZI_KX_PartPlanningCalendar
  as select from ZI_PartPlanningCalendar     as _Header
    inner join   ZI_PartPlanningCalendarDate as _Lines on  _Header.PlanningCalendar = _Lines.PlanningCalendar
