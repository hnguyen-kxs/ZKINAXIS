...
define view entity ZI_KX_PurchaseDocumentSupplier
  as select from    ZI_KX_PurchaseDocument as _PurDoc
    left outer join ZI_Supplier            as _Supplier on _PurDoc.SupplierAccountNumber = _Supplier.AccountNumberofSupplier
{
