...
define view entity ZI_KX_LocationStock
  as select from    ZI_LocationStock    as _LocationStock
    left outer join ZI_StorageLocations as _StorageLocations on  _LocationStock.StorageLocation = _StorageLocations.StorageLocation
