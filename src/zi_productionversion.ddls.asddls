...
@VDM.viewType: #BASIC
define view entity ZI_ProductionVersion
  as select from    mkal            as _ProdVer
    inner join      ZI_TVARVC_Plant as _TvarvcPlant on _ProdVer.werks = _TvarvcPlant.Low
    left outer join ZI_ProductPlant as _ProdPlant   on  _ProdVer.matnr = _ProdPlant.MaterialNumber
